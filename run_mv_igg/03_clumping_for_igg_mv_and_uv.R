...
for (n in 1:9) {
	...
	clumped <- function_for_shlop_28_12_2017(cycle_chr_pos,p_value="p",pos="Pos",snp="marker",delta=5e5,chr="Chr",thr=5e-8/(9+21),trait="trait")
...
for (n in 1:77) {
    ...
    clumped <- function_for_shlop_28_12_2017(cycle_chr_pos, p_value="p", pos="Pos", snp="marker", delta=5e5, chr="Chr", thr=5e-8/21, trait=NULL)


    z <- paste("/home/common/projects/Multivariate_analysis_IgG/2020_work_for_paper/results/clumping/clumping_uv/", names_for_save_uv[n], sep="")
